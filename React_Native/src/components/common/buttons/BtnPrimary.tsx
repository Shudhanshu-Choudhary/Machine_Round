...
const BtnPrimary: React.FC<props> = ({label, isActive= true, handlePress}) => {
  ...
  return (
    <TouchableOpacity style={styles.container} disabled={!isActive} onPress={handlePress}>
        <View 
          style={[styles.btnContainer, {backgroundColor: isActive ? colorPrimary : colorSecondary}]}>
